...
def register_pregnancy():
    ...
    # Directly create dictionary representations
    patient_resource = {
        ...
        "gender": patient_details.get("gender", "female"), # Default to female for ANC context
        "identifier": [{
            "use": "official",
    ...
    # Conceptual condition representing pregnancy
    # pregnancy_condition_dict = {
    #     "id": create_fhir_id(),
    ...
    # }
    # This conceptual condition is noted but not directly added to EpisodeOfCare in this simplified dictionary structure.
    ...
    episode_resource = {
        ...
        "period": {"start": datetime.utcnow().isoformat()} # Pregnancy starts now
    }
...
def get_patient_registration_questionnaire():
    ...
    # Directly create dictionary representation
...
def schedule_anc_visits():
    ...
    for i, (weeks, description) in enumerate(visit_weeks):
        ...
        # Directly use dictionary representation
...
def register_child():
    ...
    patient_resource = {
        ...
        "gender": child_details.get("gender"), # e.g., "male", "female", "other", "unknown"
        "identifier": [{
            "use": "official",
...
def growth_monitoring():
    ...
    if all(obs['interpretation'][0]['text'].startswith("Normal") for obs in observations):
...
def home():
    return jsonify({
        ...
        "fhir_resources_available": False # Hardcoded to False
    })
